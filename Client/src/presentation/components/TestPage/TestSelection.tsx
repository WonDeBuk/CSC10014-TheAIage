      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {AVAILABLE_TESTS.map((test) => (
            <div
              key={test.id}
              onClick={() => navigate(test.path)} // Chuyển trang khi click
              className={`
