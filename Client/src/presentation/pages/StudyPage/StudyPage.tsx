...
import MoodTracker from "@/presentation/components/StudyPage/MoodTracker/MoodTracker";
...
const StudyPage: React.FC = () => {
  ...
  const [actParam, setActParam] = useState(searchParams.get("session"));
  ...
  return (
    <div
      className="min-h-full w-full flex hero-bg font-sans 
    ...
    >
      ...
      <aside
        className="w-86 border-r border-slate-200 
        ...
        <nav className="flex-1 p-4 space-y-2 flex flex-col gap-3 justify-start items-center">
          <button
            className="w-full flex items-center 
                                       ...
                                       hover:bg-gray-200 shadow-md"
            onClick={() => {
              setActParam("pomodoro");
